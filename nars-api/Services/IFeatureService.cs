...
public interface IFeatureService
{
    ...
    /// <summary>Deletes all roads owned by the user (with their house entrances and registry entries) and returns how many roads were deleted.</summary>
    Task<int> ClearAllRoadsAsync(Guid userId, CancellationToken ct);
    /// <summary>
