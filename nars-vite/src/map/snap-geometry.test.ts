...
import { closestOnSegment, closestOnCirclePerimeter, pixelDist, closestOnSegmentProjected } from './snap-geometry'
...
describe('snap-geometry.ts', () => {
    ...
    describe('closestOnSegmentProjected', () => {
        ...
        it('handles degenerate segment (zero length)', () => {
            const { unproject } = makeProject()
            const result = closestOnSegmentProjected(100, 100, 500, 500, 500, 500, 0.001, 0.001, unproject)
            expect(result).not.toBeNull()
