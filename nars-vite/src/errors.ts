...
export function createNetworkError(message: string, context: ErrorContext = {}, cause?: unknown): NarsError {
    return new NarsError(ErrorCode.NETWORK, message, context, cause)
}

export function createValidationError(message: string, context: ErrorContext = {}, cause?: unknown): NarsError {
    return new NarsError(ErrorCode.VALIDATION, message, context, cause)
}

export function createAuthError(message: string, context: ErrorContext = {}, cause?: unknown): NarsError {
    return new NarsError(ErrorCode.AUTH, message, context, cause)
}

export function createNotFoundError(message: string, context: ErrorContext = {}, cause?: unknown): NarsError {
    return new NarsError(ErrorCode.NOT_FOUND, message, context, cause)
}

export function createServerError(message: string, context: ErrorContext = {}, cause?: unknown): NarsError {
    return new NarsError(ErrorCode.SERVER, message, context, cause)
}

export function createTimeoutError(message: string, context: ErrorContext = {}, cause?: unknown): NarsError {
    return new NarsError(ErrorCode.TIMEOUT, message, context, cause)
}

export function createPermissionError(message: string, context: ErrorContext = {}, cause?: unknown): NarsError {
    return new NarsError(ErrorCode.PERMISSION, message, context, cause)
}

export function createConflictError(message: string, context: ErrorContext = {}, cause?: unknown): NarsError {
            ...
            const narsError =
                error instanceof NarsError
                    ...
                    : error instanceof TypeError || error instanceof DOMException
                      ? createNetworkError(error instanceof Error ? error.message : 'Unknown error', {}, error)
                      : null
