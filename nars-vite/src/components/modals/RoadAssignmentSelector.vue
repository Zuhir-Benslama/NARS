...
<template>
    <template v-if="m.entranceTypeKey === 'main_entrance'">
        ...
        <div v-if="m.selectedRoadIdx !== ''" class="modal-field">
            ...
            <div class="modal-input-row">
                <input v-model.number="m.entranceNumber" type="number" class="modal-input modal-input-narrow" min="1" />
    ...
    <template v-if="m.entranceTypeKey === 'secondary_entrance'">
        <div class="modal-field">
            ...
            <select v-model="m.selectedMainIdx" :class="['modal-input', { error: m.errors.mainEntrance }]">
