...
export const useLayerStore = defineStore('layers', {
    ...
    getters: {
        ...
        secondaryEntrances: (state) =>
            state.houseEntrances.filter((e: LayerEntry) => e.data.entranceTypeKey === 'secondary_entrance'),
        ...
        mainEntranceCount: (state) =>
            state.houseEntrances.filter((e: LayerEntry) => e.data.entranceTypeKey === 'main_entrance').length,
        secondaryEntranceCount: (state) =>
            state.houseEntrances.filter((e: LayerEntry) => e.data.entranceTypeKey === 'secondary_entrance').length,
